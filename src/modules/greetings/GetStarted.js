...
module.exports = (bot) => {
  bot.hear(
    /(hello)|(hi)|(good pm)|(good am)|(good)|(tanong)|(ask)|(kelan)|(saan)/,
    (payload, chat) => {
      const buttons = [
        {
          type: "postback",
